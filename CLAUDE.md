...
- **Debugging & Troubleshooting**
  ...
  - **Code is ground truth:** Verify against source code; treat docs as hints only — they may be stale or wrong.
  - **Multiple hypotheses:** Propose ≥2 root-cause hypotheses before settling on one.
  - **No self-validation:** Surface assumptions to the user; do not confirm them yourself.
  ...
  - **Admit ignorance:** If you can't explain a key fact, say so immediately; do not fabricate.

- **Scope & Changes**

  - **First Principles:** Start from fundamental facts, constraints, and goals; question inherited assumptions, then rebuild the solution from the ground up.
